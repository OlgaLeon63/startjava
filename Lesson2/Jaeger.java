public class Jaeger {
    ...
    public boolean drift() {
        System.out.println(modelName + ": дрифт установлен");
        return true;
    }
    ...
    public boolean scanKaiju() {
        System.out.println(modelName + ": поиск Кайдзю");
        return true;
    }

    public boolean useWeapons() {
        System.out.println(modelName + ": используется оружие");
        return true;
    }
}